...
TRAIN_IMG_DIR = 'data/train2014/'
VALID_IMG_DIR = 'data/val2014/'

TRAIN_CAP_PATH = 'data/annotations/captions_train2014.json'
VALID_CAP_PATH = 'data/annotations/captions_val2014.json'
